...
//    denominator = 1;
  ...
  public int fracs() {                         // DO NOT CHANGE THIS SIGNATURE!
    // Fix the bug that prevents this method from working correctly.
    // Add static before the numberOfFractions, so every object in the class can access this variable
  ...
  public static void main(String[] argv) {
    ...
    // If you use f0.add(f1).add(f2), you will end up with creating 2 objects, one more than f0.add(sumOfTwo). That's why you get 7 as the total number of the Fractions object instead of 6
