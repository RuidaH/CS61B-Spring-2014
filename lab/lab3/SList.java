...
//  }
    ...
    public void insertEnd(Object obj) {
        if (head == null) {
            ...
            SListNode cur = new SListNode(obj);
            tail.next = cur;
            tail = cur;
        }
        size++;
  ...
  public static void main (String[] args) {
      ...
      sl.insertEnd(new Integer(6));
      sl.insertEnd(new Integer(9));
      sl.insertEnd(new Integer(12));
      
      System.out.println("The resulting list: " + sl.toString());
      
      sl.insertFront(new Integer(3));
      sl.insertEnd(new Integer(15));
      
      System.out.println("The new resulting list:" + sl.toString());
