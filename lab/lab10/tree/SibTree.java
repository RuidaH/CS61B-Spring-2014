...
public class SibTree extends Tree {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("  ERROR1:  unexpected exception while removing.");
    }
    try {
      r2.removeLeaf();
    } catch (Exception e) {
      System.out.println("  ERROR2:  unexpected exception while removing.");
    }
    try {
      r3.removeLeaf();
    } catch (Exception e) {
      System.out.println("  ERROR3:  unexpected exception while removing.");
    }
    try {
      r.removeLeaf();
    } catch (Exception e) {
      System.out.println("  ERROR4:  unexpected exception while removing.");
    }
    if (t.size() != 0) {
      System.out.println("  ERROR:  tree size is " + t.size() +
                         " but should be zero.");
