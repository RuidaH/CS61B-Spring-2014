...
class Tree234Node {
  ...
  public void ResetTreeNode(int keys, int key1, int key2, int key3, Tree234Node parent, Tree234Node child1, Tree234Node child2, Tree234Node child3, Tree234Node child4) {
      this.keys = keys;
      this.key1 = key1;
      this.key2 = key2;
      this.key3 = key3;
